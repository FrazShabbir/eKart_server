        ...
        <div class="row">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <img src="{{asset('storage/data/industry/'.$project->imageIcon) }}" height="50" width="50" class="img-thumbnail"/> </td>
                                <td>
            ...
            <div class="col-md-6">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" method="post" action="{{ route('admin.industry.create')}}" enctype="multipart/form-data">
                            @csrf
