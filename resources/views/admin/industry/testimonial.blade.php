...
@section('title','Industry Testimonial')
...
<div class="content-wrapper" >
    ...
    <div class="page-heading">
        <h1 class="page-title">Industry Testimonial</h1>
    </div>
    <div class="page-content fade-in-up" style="min-height:700px;">
        <div class="row">
            <div class="col-md-6">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Industry Testimonial</div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> <img src="{{asset('storage/data/testimonial/'.$testimonial->icon) }}" alt="" class="img-thumbnail" height="50" width="50"> </td>
                                <td>
            ...
            <div class="col-md-6">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" method="post" action="{{ route('admin.industry.testimonial.create')}}" enctype="multipart/form-data">
                            @csrf
...
<div class="modal fade" id="deleteProject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.industry.testimonial.delete') }}" enctype="multipart/form-data" method="post">
                @csrf
...
<div class="modal fade" id="editProject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.industry.testimonial.update') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-body">
