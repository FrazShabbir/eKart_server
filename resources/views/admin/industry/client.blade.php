    ...
    <div class="page-content fade-in-up" style="min-height:700px;">
        <div class="row">
            <div class="col-md-6">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title"> Industries Client Logos</div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{  $client->title}}</td>
                                <td> <img src="{{asset('storage/data/clients/'.$client->logo) }}" alt="" class="img-thumbnail" height="50" width="50"> </td>
                                <td>
            ...
            <div class="col-md-6">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" method="post" action="{{ route('admin.industry.client.create')}}" enctype="multipart/form-data">
                            @csrf
...
<div class="modal fade" id="deleteProject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.industry.client.delete') }}" enctype="multipart/form-data" method="post">
                @csrf
...
<div class="modal fade" id="editProject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.industry.client.update') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-body">
                    <input type="hidden" id="update_id" name="client_id">
                    <div class="form-group">
                        <label for="">
                            Titel
                        </label>
