        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" method="post" action="{{ route('admin.service.client.create')}}" enctype="multipart/form-data">
                            @csrf
...
<div class="modal fade" id="deleteProject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.service.client.delete') }}" enctype="multipart/form-data" method="post">
                @csrf
...
<div class="modal fade" id="editProject" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.service.client.update') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-body">
