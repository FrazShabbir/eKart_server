...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">Accessibilitys </h1>
    </div>
    <div class="page-content fade-in-up" style="min-height:700px;">
        <div class="ibox">
            <div class="ibox-body">
                <form action="{{ route('admin.accessibilitys.update')}}" method="post" enctype="multipart/form-data">
                    <div class="row">
                        @csrf
                            <input type="hidden" name="accessibilitys_id"  value="{{$accessibilitys->id }}">
                            <div class="col-sm-6 form-group">
                                <label >Heading</label>
                                <input class="form-control @error('heading') is-invalid @enderror" type="text" name="heading"
                                value="{{$accessibilitys->heading}}" >
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Content Heading</label>
                                <input class="form-control @error('subhead1') is-invalid @enderror" type="text"
                                 value="{{$accessibilitys->content_heading}}"  placeholder="" name="content_heading">
                            </div>
                            ...
                            <div class="col-sm-6 form-group">
                                     @if($accessibilitys->banner == '')
                                            @php $banner = 'no_img.png';  @endphp
                                     @else
                                            @php $banner =$accessibilitys->banner;  @endphp
                                     @endif
                            ...
                            <div class="col-sm-12 form-group">
                                <label> Content</label>
                                <textarea class="form-control report-txt summernote3" name="content">{{$accessibilitys->content }} </textarea>
                            </div>
                    </div>
