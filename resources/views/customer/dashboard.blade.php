                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 dash-brd-part">
                                <div class="ibox bg-success1 color-white widget-stat">
                                    <div class="ibox-body1">
                                        <h2 class="m-b-5 font-strong">
                                            <a class="pur-view-text1" href="#">
                                                <i class="fa fa-signal"></i>
                                            </a>
                                        </h2>
                                        <div class="m-b-5">
                                                <a class="pur-view-text" href="#">Purchased Reports</a>
                                        </div>
                                                <i class="fa fa ti-bar-chart widget-stat-icon"></i>
                                        <div>
                                                <a class="pur-view-text" href="{{ route('customer.work') }}">
                                                        <span class="dash-read-btn">View  All Reports</span>
                                                </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="ibox bg-warning1 color-white widget-stat">
                                    <div class="ibox-body1">
                                        ...
                                        <div class="m-b-5"><a class="pur-view-text" href="#">Your Work</a></div>
                                        <i class="fa fa ti-bar-chart widget-stat-icon"></i>
                                        <div><a class="pur-view-text" href="#"><i
                                                    class="fa fa-level-up m-r-5"></i><small>Article / News / Reports /
                                                    etc.</small></a></div>
                                        <div><a class="pur-view-text" href="{{ route('customer.work.add') }}"><span class="dash-read-btn"> <i
                                                    ...
                                                    @foreach ($insights as $insight)
                                                        <div class="blog_item">
                                                            ...
                                                            <div class="blog_details">
                                                                ...
                                                                <p class="news-text">
                                                                    <a href="{{ route('article.detail',$insight->id) }}" style="color:#000">
