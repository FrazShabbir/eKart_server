                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="checkout__input">
                                        <p>Name<span>*</span></p>
                                        <input type="text" placeholder="Name" value="{{ $user->name }}" required name="name">
                                ...
                                <div class="col-lg-3">
                                    <div class="checkout__input">
                                            ...
                                            <a href="{{asset('storage/data/'.$user->UserDetail->resume) }}" class="btn btn-info btn-sm" download="download" style="color:#fff;font-size:11px;font-weight:bold">Download Resume (doc / pdf / Reference Doc)</a>
