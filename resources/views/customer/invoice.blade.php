                                                ...
                                                <div>
                                                    ...
                                                    <ul class="list-unstyled m-t-10">
                                                        <li class="m-b-5">
                                                            ...
                                                            Vani Nagar, Malkajgiri, Hyderabad, 500047
                                                        </li>
                                                        <li class="m-b-5">
                                                ...
                                                @foreach ($orderdetails as $orderdetail)
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <strong>
                                                                   @if( $orderdetail->report) {{ $orderdetail->report->title }} @endif
                                                                </strong>
                                                            </div>
                                                            <small>    @if( $orderdetail->report) {{ $orderdetail->report->author }} @endif</small>
                                                        </td>
