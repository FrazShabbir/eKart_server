                ...
                <ul class="side-menu metismenu">
                    ...
                    <li class="@if (Request::is('admin/user*')) active @endif">
                        ...
                        <ul class="nav-2-level collapse {{ request()->is('reg-users') ? 'in' : '' }}">
                            <li>
                                <a href="{{ route('admin.requirements') }} ">  Requirements </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.applied.user') }} ">  Applied User </a>
                            </li>
                    ...
                    <li class="@if (Request::is('admin/service') or
                        Request::is('admin/service/template') or
                        Request::is('admin/service/client') or
                        Request::is('admin/service/testimonial')) active @endif">
                        <a href=" #">
                            <i class="sidebar-item-icon fa fa-edit"></i>
                            <span class="nav-label">Services Module</span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                    ...
                    <li class="@if (Request::is('admin/industry*') or Request::is('admin/subIndustry*')) ) active @endif">
                        <a href=" javascript:;">
                            <i class="sidebar-item-icon fa fa-edit"></i>
                            <span class="nav-label">Industries Module</span><i class="fa fa-angle-left arrow"></i></a>
                    ...
                    <li class="@if (Request::is('admin/regions') or
                        Request::is('admin/regions/template') or
                        Request::is('admin/region/client') or
                        Request::is('admin/region/testimonial')) active @endif">
                    ...
                    <li class="@if (Request::is('admin/reports') or
                    Request::is('admin/reports/users') or
                    Request::is('admin/report/create') or
                    Request::is('admin/report/issues')) active @endif">
                    <a href=" #"><i class="sidebar-item-icon fa fa-edit"></i>
                        <span class="nav-label">Articles</span><i
                            class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse"> 
                            <li>
                                <a href="{{ route('admin.report.article.template') }}">Article Template </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.report.article.category') }}">Categories</a>
                            </li> 
                            <li>
                                <a href="{{ route('admin.report.article.index') }}">Articles</a>
                            </li>
                    ...
                    <li class="@if (Request::is('admin/reports') or
                        ...
                        <a href=" #"><i class="sidebar-item-icon fa fa-edit"></i>
                            <span class="nav-label">Works / Reports</span><i
                                class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="{{ route('admin.report.issues') }}"> Issues
                                    <span class="badge badge-primary badge-circle m-r-5 m-b-5"> {{ $reportIssue }}
                                    </span>
                                </a>
                            </li>
                    ...
                    <li>
                        <a href="javascript:;"><i class="sidebar-item-icon fa fa-envelope"></i>
                            <span class="nav-label">Messages / Inbox </span><i class="fa fa-angle-left arrow"></i></a>
                        <ul class="nav-2-level collapse">
                            <li>
                                <a href="#">Messages</a>
                            </li>
