        ...
        <div class="row">
            <div class="col-lg-12 content-wrap content-reponsive">
                <div class="content-main pdbtm-none">
                    <h2 class="artl-heading indu-heading"> All Articles</h2>
                    ...
                    <div class="indu-client-block">
                        <h2 class="artl-heading">Articles Categories</h2>
                        <div class="industry-client-logos">
                           <div class="row">
                            @foreach ($article_categories as $article )
                            <div class="col-xs-3 col-sm4 col-md-3 indu-clogos">
                                <img src="{{'https://ui-avatars.com/api/?name='.ucfirst($article->title) .'&size=80'}}"
                                class="img-responsive dummy-logo" alt="" >
                                <p class="logo-title"> <a href="{{ route('article.type', $article->slug) }}">  {{ ucfirst($article->title) }} </a> </p>
                            </div>
                            @endforeach
                           </div>
