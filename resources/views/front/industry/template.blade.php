                ...
                <div class="content-main pdbtm-none">
                    ...
                    <div class="clear row marginbtm30">
                        <div class="col-sm-9 col-md-9 hidden-xs catg-icon-img">
                            <img class="img-responsive catg-icon"  src="{{asset('storage/data/reports/'.$industryTemplate->banner) }}" alt="">
                            <br><br>
                        ...
                        <div class="industry-client-logos">
                            <div class="row">
                                @foreach ($industries as $industry ) 
                                    <div class="col-lg-3 col-xs-3 col-sm4 col-md-3 indu-clogos mb-4">
