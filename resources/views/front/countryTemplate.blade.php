...
@section('title', 'Country Template')
@section('customStyle')
<style>
    .logo-title a:hover{
        color:#000;
            ...
            <div class="col-lg-12">
                <div class="breadcrumb__text">
                    <div class="breadcrumb__links">
                        ...
                        <a href="{{ route('region.template') }}">Region Template</a> /
            ...
            <div class="col-lg-12 content-wrap content-reponsive">
                <div class="content-main pdbtm-none">
                    ...
                    <div class="clear row marginbtm30">
                        <div class="col-sm-9 col-md-9 hidden-xs catg-icon-img">
                            <img class="img-responsive set-image-for-banner catg-icon"
                                src="{{asset('storage/data/regions/'.$region->banner) }}" alt="">
                    ...
                    <div class="indu-client-block">
                        <h2 class="artl-heading">Our Countries</h2>
                        <div class="industry-client-logos">
                            @if($countries->count()>0)
                            @foreach ($countries as $country )
                            <div class="col-xs-3 col-sm4 col-md-3 indu-clogos">
                                <img src="{{asset('storage/data/country/'.$country->imageIcon) }}"  class="img-responsive dummy-logo" alt="" >
                                <p class="logo-title">
                                    <a href="{{ route('country.template.report',$country->id)}}">
                                        {{ $country->country}}
                                    </a>
                                </p>
                            </div>
                            ...
                            @else
                                <div class="col-xs-3 col-sm4 col-md-3 indu-clogos">
                                    ...
                                    <p class="logo-title text-danger">
                                            No country found in region "{{ $region->region }}"
                                    </p>
                                </div>
                            @endif
                                                    ...
                                                    <div class="item">
                                                        <div class="client-inners">
                                                            <img src="{{asset('storage/data/clients/'.$client->logo) }}"
                                                                alt="{{ $client->title }}" title="{{ $client->title }}">
                                                        </div>
                                                    </div>
                                                    </div>
                                                @endforeach
                                        ...
                                        <div id="testim-content" class="cont">
                                            ...
                                            @foreach($testimonials as $testimonial)
                                                ...
                                                @if($no == 1)
                                                    <div class="active">
                                                        <div class="img">
                                                            <img src="{{asset('storage/data/testimonial/'.$testimonial->icon) }}" alt=""></div>
