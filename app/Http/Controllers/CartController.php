...
class CartController extends Controller
{
    ...
    public function addCart(Request $request)
    {
        ...
        if ($request->report_id) {
            ...
            foreach ($orders as $order) {
                ...
                foreach ($orders_details as $order_detail) {
                    $reports[] = $order_detail->report_id;
                }
            }
            // dd($reports, $request->report_id);
            if (in_array($request->report_id, $reports)){
        ...
        if ($request->subindustry_id) {
            ...
            if (in_array($request->subindustry_id, $reportss)){
  
                return redirect()->back()->with('error', 'You have already purchased this Category.');
            }
