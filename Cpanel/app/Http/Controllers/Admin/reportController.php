...
class reportController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('projectPhoto')) {
            ...
            $extension = $request->file('projectPhoto')->getClientOriginalExtension();
            // Filename To store
            $projectPhoto = 'P_' . time() . '.' . $extension;
            $path = $request->file('projectPhoto')->storeAs("public/data/reports/", $projectPhoto);
        }else{
    ...
    public function article ()
    {
        ...
        $managers = User::role('Manager')->get();
        $employees = User::role('Employee')->get();
        return view('admin.reports.article.create',compact('projects','services','industries','subindustries','regions','countries','managers','employees'));
    ...
    public function articleSave (Request $request)
    {
        ...
        $artice = new Article;
        $artice->articleType = $request->articleType;
        ...
        if ($request->hasFile('photo')) {
            ...
            $article = 'article' . time() . '.' . $extension;
            $path = $request->file('photo')->storeAs("public/data/reports/", $article);
        }else{
            $article = 'no-image.jpg';
        }
        $artice->photo = $article;
        $artice->save();
    ...
    function articleEdit($id)
    {
        ...
        $managers = User::role('Manager')->get();
        $employees = User::role('Employee')->get();
        return view('admin.reports.article.edit',compact('artice','projects','services','industries','subindustries','regions','countries','managers','employees'));
