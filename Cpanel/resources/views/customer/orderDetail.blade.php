                                                ...
                                                <thead>
                                                  ...
                                                  @foreach ($orderdetails as $orderdetail )
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <a href="{{ route('customer.report.info',$orderdetail->report->id)}}" style="color:#3078BF"> <i class="fa fa-eye"></i> </a>
                                                            </td>
                                                            <td>
                                                                <a href="{{ route('customer.rise.issue',$orderdetail->report->id)}}" class="btn btn-sm btn-warning ">  Rise   Issue  </a>
                                                            </td>
                                                        </tr>
                                                @endforeach
                                            </table>
