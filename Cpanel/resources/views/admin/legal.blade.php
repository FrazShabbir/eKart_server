                        ...
                        @csrf
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control @error('subhead1') is-invalid @enderror" type="text"
                                 value="{{$legal->content_heading}}"  placeholder="" name="content_heading">
                            </div>
                            ...
                            <div class="col-sm-6 form-group">
                                     ...
                                     @else
                                            @php $banner =$legal->banner;  @endphp
                                     @endif
                            ...
                            <div class="col-sm-12 form-group">
                                <label> Content</label>
                                <textarea class="form-control report-txt summernote3" name="content">{{$legal->content }} </textarea>
                            </div>
                    </div>
