                        ...
                        @csrf
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control @error('subhead1') is-invalid @enderror" type="text"
                                 value="{{ $about->content_heading}}"  placeholder="" name="content_heading">
                            </div>
                            ...
                            <div class="col-sm-6 form-group">
                                     ...
                                     @else
                                            @php $banner = $about->banner;  @endphp
                                     @endif
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <textarea class="form-control report-txt summernote3" name="content">{{ $about->content }} </textarea>
                            </div>
                    </div>
