                        ...
                        @csrf
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <input class="form-control @error('subhead1') is-invalid @enderror" type="text"
                                 value="{{ $news->content_heading}}"  placeholder="" name="content_heading">
                            </div>
                            ...
                            <div class="col-sm-12 form-group">
                                <label> Content</label>
                                <textarea class="form-control report-txt summernote3" name="content">{{ $news->content }} </textarea>
                            </div>
                    </div>
