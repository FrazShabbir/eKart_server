                    ...
                    <div class="row">
                        @csrf
                            ...
                            <div class="col-sm-6 form-group">
                                     ...
                                     @else
                                            @php $banner =$privacy->banner;  @endphp
                                     @endif
                            ...
                            <div class="col-sm-12 form-group">
                                <label> Content</label>
                                <textarea class="form-control report-txt summernote3" name="content">{{$privacy->content }} </textarea>
                            </div>
                    </div>
