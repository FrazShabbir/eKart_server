                        ...
                        <form method="post" action="{{ route('admin.report.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="row  ">
                                ...
                                <div class="col-lg-6 form-group pt-3">
                                    ...
                                    <a href="{{asset('storage/app/public/data/reports/'.$report->overview->fileTableContent) }}" download="download" >
                            ...
                            <div class="row  ">
                                ...
                                <div class="col-lg-6 form-group pt-3">
                                    ...
                                    <a href="{{asset('storage/app/public/data/reports/'.$report->overview->reportOverView) }}" download="download" >
                                        <i class="fa fa-download"></i> &nbsp;Download
                                   </a>
                            ...
                            <div class="row  ">
                                ...
                                <div class="col-lg-6 form-group pt-3">
                                    <a href="{{asset('storage/app/public/data/reports/'.$report->overview->uploadDoc) }}" download="download" >
                                        <i class="fa fa-download"></i> &nbsp;Download
                                   </a>
                                </div>
                            </div>
                            ...
                            <div class="row  ">
                                ...
                                <div class="col-lg-6 form-group pt-3">
                                    ...
                                    <a href="{{asset('storage/app/public/data/reports/'.$report->overview->uploadPpt) }}" download="download" >
                                        <i class="fa fa-download"></i> &nbsp;Download
                                   </a>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-sm-6 form-group">
                                        <div class="img-thumbnail">
                                            <img src="{{asset('storage/app/public/data/reports/'.$report->photo) }}" alt=""
