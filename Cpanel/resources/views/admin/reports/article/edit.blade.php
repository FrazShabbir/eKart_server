                            ...
                            <form method="post" action="{{ route('admin.report.article.update') }}"   enctype="multipart/form-data" id="update_form">
                                ...
                                <div class="row">
                                    <div class="col-sm-3 form-group">
                                        ...
                                        <select class="form-control" name="articleType" required>
                                            ...
                                            <option value="insights" @if ($artice->articleType == 'insights') selected @endif>   Insights </option>
                                            <option value="articles" @if ($artice->articleType == 'articles') selected @endif>
                                                Articles </option>
                                            <option value="news" @if ($artice->articleType == 'news') selected @endif> News
                                            </option>
                                            <option value="blogs" @if ($artice->articleType == 'blogs') selected @endif> Blogs
                                            </option>
                                            <option value="markets" @if ($artice->articleType == 'markets') selected @endif>
                                                Markets </option>
                                            <option value="financialmarkets"
                                                @if ($artice->articleType == 'financialmarkets') selected @endif> Financial Markets
                                            </option>
                                            <option value="chemicalsandmaterials"
                                                @if ($artice->articleType == 'chemicalsandmaterials') selected @endif> Chemicals and Materials
                                            </option>

                                            <option value="energynaturalresources"
                                                @if ($artice->articleType == 'energynaturalresources') selected @endif> Energy & Natural
                                                Resources </option>
                                            <option value="agriculturefoodandbeverages"
                                                @if ($artice->articleType == 'agriculturefoodandbeverages') selected @endif> Agriculture Food and
                                                Beverages </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <img src="{{ asset('storage/app/public/data/reports/' . $artice->photo) }}"
