                                ...
                                <div class="col-sm-3 form-group">
                                    ...
                                    <select class="form-control" name="articleType" required >
                                            <option value="" disabled selected> Artice Type</option>
                                             ...
                                             <option value="financialmarkets"> Financial Markets </option>
                                             <option value="chemicalsandmaterials"> Chemicals and Materials </option>
                                             <option value="energynaturalresources"> Energy & Natural Resources </option>
                                             <option value="agriculturefoodandbeverages"> Agriculture Food and Beverages </option>
                                    </select>
                                </div>
                                <div class="col-sm-3 form-group">
