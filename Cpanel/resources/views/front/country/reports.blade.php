                ...
                <div class="col-lg-12">
                    <div class="breadcrumb__text">
                        <div class="breadcrumb__links">
                            ...
                            <a href="{{ route('country.template',$country->region->id) }}"> Country Template </a> /
            ...
            <div class="row">
                <div class="col-lg-12 content-wrap content-reponsive">
                    <div class="content-main pdbtm-none">
                        <h2 class="artl-heading">  {{ $country->country }} </h2>
                        <div class="clear row marginbtm30">
                            <div class="col-sm-9 col-md-9 hidden-xs catg-icon-img">
                                ...
                                src="{{asset('storage/app/public/data/country/'.$country->imageIcon) }}"
                                alt=""> <br><br>
                                <p class="discr-text"> {{ $country->description }} </p>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                    ...
                                    <div class="author-text text-center" >
                                        <br>
                                            <p class="text-danger">
                                                    <strong> No reports against "{{ $country->country }}"  </strong>
