...
@section('content')
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-md-8">
                                                            <div class="product-details mr-2">
                                                                ...
                                                                <hr>
                                                                <h6 class="mb-0">Cart Items  ({{ Cart::count() }})</h6>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="payment-info">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text"  class="form-control credit-inputs" placeholder="Name on card" name="cardName">
                                                                </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text"  class="form-control credit-inputs" placeholder="Address" name="address">
                                                                </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="text"  class="form-control credit-inputs" placeholder="0000 0000 0000 0000" name="cardNumber">
                                                                </div>
                                                                ...
                                                                <button  class="btn btn-primary btn-block d-flex justify-content-between mt-3"  type="button" data-toggle="modal" data-target="#loginConfirm">
                                                                    <span> Login to Proceed  </span>
                                                                    <span>Checkout<i
                                                                        class="fa fa-lock ml-1"></i></span>
                                                                </button>
                                                    ...
                                                    <div class="row no-gutters">
                                                        <div class="col-md-12">
                                                            <div class="product-details mr-2">
                                                                ...
                                                                <div
                                                                    class=" align-items-center text-center  p-5  text-danger ">
    ...
    <div class="modal fade" id="loginConfirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
