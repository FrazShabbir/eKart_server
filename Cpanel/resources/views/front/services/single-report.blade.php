                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="{{ route('homePage') }}">
                            <img src="{{ asset('storage/app/public/data/' . $logo->logo) }}" alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="header__nav__option">
                        ...
                        @if (Auth::user())
                            <a href="{{ route('customer.dashboard') }}">
                                ...
                                <img src="{{ asset('public/frontEnd/img/dashbaord.png') }}"class="img-responsive account-iocn1"
                                    alt="">
                            </a>
                        @else
                            <a href="{{ route('login') }}">
                                <img src="{{ asset('public/frontEnd/img/user-1.png') }}"class="img-responsive account-iocn1"
                                    alt="">
                            </a>
                        @endif
                        ...
                        <a href="#" class="search-switch"><img
                                src="{{ asset('public/frontEnd/img/bar-icon-1.png') }}" alt=""></a>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="breadcrumb__text">
                        <div class="breadcrumb__links">
                            ...
                            <a href="{{ route('sub.industry.template',$report->industry->id) }}"> {{ $report->service->serviceType }} </a> /
                ...
                <div class="col-lg-2 rt-wrap1">
                    <div class="hidden-xs catg-icon-img">
                        <img class="img-responsive single-img"
                            src="{{ asset('storage/app/public/data/reports/' . $report->photo) }}"
                        ...
                        <div class="hidden-xs hidden-sm rpt-pg-cta">
                            ...
                            <form method="post" action="{{ route('cart.store') }}">
                                ...
                                <input type="hidden" name="report_author" value="{{ $report->author }}">
                                <input type="hidden" name="report_price" value="{{ $report->price }}">
                                <input type="hidden" name="report_qty" value="1">
