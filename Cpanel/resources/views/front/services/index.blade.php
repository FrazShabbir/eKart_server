        ...
        <div class="row">
            <div class="col-lg-12 content-wrap content-reponsive">
                <div class="content-main pdbtm-none">
                    <h2 class="artl-heading indu-heading">  {{ $serviceTemplate->description }} </h2>
                    <div class="clear row marginbtm30">
                        <div class="col-sm-9 col-md-9 hidden-xs catg-icon-img">
                            <img class="img-responsive catg-icon"  src="{{asset('storage/app/public/data/services/'.$serviceTemplate->banner) }}" alt=""> <br><br>
                    ...
                    <div class="indu-client-block">
                        <h2 class="artl-heading">Our Services</h2>
                        <div class="industry-client-logos">
                            @foreach ($services as $service )
                            <div class="col-xs-3 col-sm4 col-md-3 indu-clogos">
                                <img src="{{asset('storage/app/public/data/services/'.$service->imageIcon) }}"
                                    class="img-responsive dummy-logo" alt="" >
                                <p class="logo-title">
                                    <a href="{{ route('front-reports',$service->id)}}">
                                        {{ $service->serviceType}}
                                    </a>
                                </p>
                            </div>
                    ...
                    <div class="our-exp-block">
                        ...
                        <div class="industry-client-logos">
                            ...
                            <div class="col-xs-4 col-sm4 col-md-4 our-exp">
                                <img src="{{asset('storage/app/public/data/reports/'.$serviceTemplate->expert) }}"
