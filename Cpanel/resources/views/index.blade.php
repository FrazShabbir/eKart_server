                                    ...
                                    <div class="owl-carousel owl-theme">
                                        ...
                                        <div class="blog_item">
                                            <div class="blog_image">
                                                ...
                                                src="{{asset('app/public/data/reports/'.$new->photo) }}" alt="images">
                                            </div>
                                ...
                                <div class="blog_content">
                                    <div class="owl-carousel owl-theme">
                                        ...
                                        <div class="blog_item">
                                            <div class="blog_image">
                                                <img class="img-responsive img-fluid"
                                                src="{{asset('app/public/data/reports/'.$insight->photo) }}" alt="images">
                                            </div>
                                            <div class="blog_details">
                                                <div class="blog_title">
                                ...
                                <div class="blog_content">
                                    <div class="owl-carousel owl-theme">
                                        ...
                                        <div class="blog_item">
                                            <div class="blog_image">
                                                <img class="img-responsive img-fluid"
                                                src="{{asset('app/public/data/reports/'.$market->photo) }}" alt="images">
                                            </div>
                                            <div class="blog_details">
                                                <div class="blog_title">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 serv-part">
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <img src="{{asset('app/public/data/'.$home->head1img)}}" class="img-responsive service-img" alt="">
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-9 serv-part-1">
                        <div class="card-body">
                            ...
                            <div class="tags">
                                <span class="share-links read-btn"> <a href="#"> Read More</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 serv-part1">
                    <div class="col-lg-9 col-md-9 col-sm-9 serv-part-2">
                        <div class="card-body">
                            ...
                            <div class="tags">
                                <span class="share-links read-btn1"> <a href="#"> Read More</a></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <img src="{{asset('app/public/data/'.$home->head2img)}}" class="img-responsive service-img1" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 serv-part">
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <img src="{{asset('app/public/data/'.$home->head3img)}}" class="img-responsive service-img" alt="">
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-9 serv-part-1">
                        <div class="card-body">
                            <a href="#" class="h2 text-decoration-none text-dark service-heading">
            ...
            <div class="row">
                <div class="col-md-12 serv-part1">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3">
                        <img src="{{asset('app/public/data/'.$home->head4img)}}" class="img-responsive service-img1" alt="">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="col-md-12 as-min">
                                ...
                                <div class="col-sm-3 col-md-3 hidden-xs as-mi1">
                                    <img src="{{asset('app/public/data/reports/'.$lastReport->photo)}}" class="img-reponsive mining-img">
                                </div>
                            </div>
                    ...
                    @foreach ($financialmarkets as $market )
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <div class="blog__item">
                                ...
                                data-setbg="{{asset('app/public/data/reports/'.$market->photo) }}"></div>
